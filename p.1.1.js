document.addEventListener('DOMContentLoaded', () => {
  ...
  // 1. VARIÁVEIS GLOBAIS (No topo para evitar ReferenceError)
const supabaseUrl = 'https://xskwiggokqhuhznzgaka.supabase.co';
const supabaseKey = 'sb_publishable_xlUBzs1pn2bxIz64BIhJDA_Jr1DdXw6'; // Nota: use sua Service Role se for salvar dados
...
// 4. FUNÇÕES DE SUPORTE (Fora dos eventos)
...
async function saveToSupabase(features) {
    ...
    const { error } = await supabaseClient.from('geodata').insert(dataToSave);
    if (error) console.error("Erro Supabase:", error);
    else alert("Sincronizado com Supabase! ☁️");
}
